...
--
-- Host: localhost:3306
-- Generation Time: 24 Jul 2019 pada 15.58
-- Versi Server: 5.7.26-0ubuntu0.19.04.1
-- PHP Version: 5.6.40-8+ubuntu19.04.1+deb.sury.org+1
...
(21, 'Edit', 'admin/jabatan/edit_infra', 3),
...
--
ALTER TABLE `permission`
  MODIFY `id_permiss` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
