    ...
    <!-- Start Profil area -->
    <?php $this->load->view('_blocks/profile') ?>
    <!-- End Profil area -->    
    
    <!-- Start Informasi area -->
    <?php $this->load->view('_blocks/informasi') ?>
    <!-- End Informasi area -->

    <!-- Start Desa area -->
    <?php $this->load->view('_blocks/desa') ?>
    <!-- End Desa area -->

    <!-- Start Desa area -->
    <?php $this->load->view('_blocks/potensi_infra') ?>
    <!-- End Desa area -->
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="contact-icon text-center">
                            <div class="single-icon">
                                ...
                                <p>
                                    Telepon : <?= $kecamatan->no_telp_1 ?> / <?= $kecamatan->no_telp_2 ?><br>
