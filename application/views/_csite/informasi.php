                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="faq-details">
                                            <div class="panel-group" id="accordion_izin">
                                              <!-- Panel Default -->
                                              <?php 
                                                $pelayanan = $this->pelayanan_m->get_data(null, null, 'perizinan', $pemerintah->desa_id)->result_array();
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="faq-details">
                                            <div class="panel-group" id="accordion_non_izin">
                                              <!-- Panel Default -->
                                              <?php 
                                                $pelayanan = $this->pelayanan_m->get_data(null, null, 'non_perizinan', $pemerintah->desa_id)->result_array();
                                                foreach($pelayanan as $key=>$dt): 
                                              ?>
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
