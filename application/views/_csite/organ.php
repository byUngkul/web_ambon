		...
		<div class="row"> 
			<div class="col-md-3">
				<div class="thumbnails">
					<?php
						if($dt['image'] != null){
							echo "<img src=".site_url("assets/images/pegawai/".$dt['image'])." class='thumbnail' id='pegawai_photo'>";
						} else {
							echo "<img src=".site_url('assets/images/pegawai/no-image.png')." class='thumbnail' id='pegawai_photo'>";
						}
					?>
				</div>
			</div>
