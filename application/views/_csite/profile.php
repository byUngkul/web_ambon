        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="single-awesome-project">
                      <div class="row">
                          <div class="col-md-3">      
                            ...
                            <?php 
															$ketua_gank = $this->desas_m->get_organisasi(NULL, $desa_id, '0')->row_array(); 
                                // var_dump($ketua_gank);
                            ?>    
                                <center>
                ...
                <!-- End col-->
						...
						<br>
            <?php $this->load->view('_csite/organ'); ?>
            <br>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="faq-details">
                                            <div class="panel-group" id="accordion_non_izin">
                                              ...
                                              <div class="single-awesome-project">
                                                <div class="awesome-img">
                                                  <a href="#"><img src="<?= site_url('assets/images/peta/'.$pemerintah->peta)?>" alt=""></a>
                                                  <div class="add-actions text-center">
                                                    <div class="project-dec">
                                                      <a class="venobox vbox-item" data-gall="myGallery" href="<?= site_url('assets/images/peta/'.$pemerintah->peta)?>">
                                                        <h4>Peta</h4>
                                                        <span><?= $pemerintah->nama ?></span>
                                                      </a>
                                                    </div>
                                                  </div>
                                                </div>
