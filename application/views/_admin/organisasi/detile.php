<div class="card mb-3">
  <div class="card-header">
    ...
    <?= $title ?>
    <a href="<?= site_url('admin/organisasi/index')?>" class="btn btn-primary btn-sm float-right"><span><i class="fas fa-arrow-left"></i></span> Kembali</a>
  </div>
      ...
      <table class="table table-hover table-sm" id="" width="100%" cellspacing="0">
        <thead class="thead-light">
          <tr>
            ...
            <th>Jabatan</th>
            <th>Atasan</th>            
            <th style="width: 150px"> <button class="btn btn-light btn-sm float-right" data-toggle="modal" data-target="#addItem"><i class="fas fa-plus"></i>&nbsp;Tambah</button> </th>
          </tr>
        </thead>
        <tbody>
        <?php foreach($orgData->result_array() as $key=>$dt): ?>
          <tr>
            ...
            <td style="text-align: right;">
              ...
              <a href="<?= site_url('admin/organisasi/delete_item/'.$id_desa.'/'.$dt['id'])?>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
            </td>
          </tr>
        <?php endforeach; ?>
