...
<div class="modal fade" id="Delete<?= $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Apkah anda yakin mau Hapus kategori <strong><?= $row->name ?></strong> ini?  </div>
        <div class="modal-footer">
          <button class="btn btn-default" type="button" data-dismiss="modal">Cancel</button>
          <a class="btn btn-primary" href="<?= base_url('admin/kategori/delete/'.$row->id) ?>">Hapus</a>
        </div>
      </div>
    </div>
  </div><?php endforeach; ?>